...
QT_MOC_LITERAL(3, 19, 11) // "scoreToZero"

    },
    "handler\0beatMouse\0\0scoreToZero"
};
...
void handler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (handler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&handler::scoreToZero)) {
                *result = 1;
                return;
            }
        }
