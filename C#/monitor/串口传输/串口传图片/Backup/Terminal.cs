...
namespace SerialPortTerminal
{
  ...
  public partial class frmTerminal : Form
  {
    ...
    private void EnableControls()
    {
      ...
      txtSendData.Enabled = btnSend.Enabled = button_back.Enabled =button_head.Enabled=button_right.Enabled =button_stop.Enabled=button1_left.Enabled =comport.IsOpen  ;
